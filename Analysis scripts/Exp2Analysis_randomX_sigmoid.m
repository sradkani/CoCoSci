function [coeffs,dev,stats,auc] = Exp2Analysis_randomX_sigmoid(alphabet, maxMotifLength, delta, alpha, remove1st, smooth)
...
writetable(plottable, 'Rdata_randomX_sigmoid.csv')
